...
--
-- Host: 127.0.0.1    Database: clientmanager
-- ------------------------------------------------------
...
--
-- Table structure for table `cliente_representante`
--
...
CREATE TABLE `cliente_representante` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cliente_representante_cliente_id_foreign` (`cliente_id`),
  KEY `cliente_representante_representante_id_foreign` (`representante_id`),
  CONSTRAINT `cliente_representante_cliente_id_foreign` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `cliente_representante_representante_id_foreign` FOREIGN KEY (`representante_id`) REFERENCES `representantes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-14 18:30:32
